...
export default function Apply() {
  return (
    <div className=" w-full lg:px-[50px]">
      <Homelayout first={true} redbgHeight="lg:h-[107px] h-[51px] " showRbtc>
            ...
            <div className=" max-w-[880px] w-full pt-12 gap-10 flex flex-col ">
              <div className=" w-full flex flex-col gap-6 ">
                {tuitionfee?.map((item, index) => (
                  <div
                    key={index.toString()}
                    className=" w-full flex pb-6 border-b gap-12 border-secondary04 "
                  >
                    <p className=" leading-6 w-[200px] ">{item?.name}</p>
                    <p className=" font-bold leading-[28px] text-lg ">
                      {item?.fee}{" "}
                      <span className=" text-base leading-6 font-normal ">
                        {item?.name === "Module Tution payment" &&
                          "(per module weekend)"}
                      </span>
                    </p>
                  </div>
                ...
                <div className=" flex gap-3 items-center ">
                  ...
                  <div className=" flex flex-col ">
                    ...
                    <p className=" leading-6 ">
                      <span className=" text-lg font-bold ">$78</span> per month
                      for 24 months
                    </p>
                  </div>
                </div>
                <p role="button" className=" underline font-medium leading-6 ">
                  Visit Club1040 to Learn more
                </p>
              </div>
            </div>
          </div>
