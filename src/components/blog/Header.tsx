        ...
        <>
             <div className="w-full h-[200px] sm:hidden lg:flex justify-between items-center">
                <div className="pl-16">
                    ...
                    <p className="text-center text-[16px] color-white mt-3">Learn more about what we have done over the years</p>
                </div>
                
                <div className=" flex-[0.4] flex items-end">
                    <CustomInput leftIcon={<SearchNormal size={'20px'} color="grey" variant="Outline" />}  label="Search" placeholder="Search" className="w-[437px] h-[56px]" />
                </div>
            </div>
            ...
            <div className="w-full h-auto sm:flex flex-col lg:hidden bg-[#212B36] px-3">
                <div>
                    ...
                    <p className="text-left text-[14px] color-white mt-3">Learn more about what we have done over the years</p>
                </div>
            </div>
        </>
    )
