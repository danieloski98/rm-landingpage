    ...
    return (
        <Homelayout first={true} >
            ...
            <div className=' w-full text-primary lg:pl-[116px] z-10 relative py-[115px] ' >
                <h1 className=' text-[32px] leading-[48px] lg:text-5xl lg:leading-[64px] font-bold relative ' >RHEMA MENA IS FOR YOU!</h1>
                ...
                <div className=' w-full relative pt-12 flex lg:pr-12 ' >
                    ...
                    <div className=' w-full relative lg:h-[446px] h-[195px] ' >
