  ...
  return (
    <div className="w-auto h-auto mb-4">
      <div className="flex items-center" onClick={() => setIsOpen(!isOpen)}>
        ...
        {sublink.length > 0 && <p className="font-semibold text-md">{name}</p>}
        {sublink?.length > 0 && (
          <>
            {isOpen && (
              <ArrowUp2
...
export default function Navbar() {
  ...
  const activeLink = (item: { name: string; link: string }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[205px] h-[222px] bg-secondary04 right-[250px] top-[100px] rounded-[16px] absolute sm:hidden" />
