    ...
    return (
        <div className=' flex flex-col gap-1 relative z-10 text-secondary01 ' >
            ...
            <div className=' flex gap-2 mt-3 ' >
                <input placeholder='Your email address' className=' w-full lg:w-[267px] h-[48px] border bg-dark01  border-[#919EAB52] outline-none rounded-lg px-4 bg-transparent text-sm leading-[22px] ' />
